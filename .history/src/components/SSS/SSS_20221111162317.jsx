...
useEffect(function(){
  ...
  return (
        ...
        <div className='home__content slider'>
                ...
                <button className="home__content__list__button __content__list__button__left slider_" onClick={handleChangeCart}><i id='pev' className="fa-solid fa-chevron-left"></i></button>
