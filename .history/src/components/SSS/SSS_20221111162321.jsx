...
useEffect(function(){
  ...
  return (
        ...
        <div className='home__content slider'>
                        ...
                        {banner.map(value => {
                            return (
                                <div key={value._id} className="home__content__list__cart slider__img">
                                    <div className="home__content__list__cart__img slider__img-src"><img src={value.thumb} alt="" /></div>
                                </div>
                            )
                        })}
                ...
                <button className="home__content__list__button __content__list__button__left slider__rgt" onClick={handleChangeCart}><i id='pev' className="fa-solid fa-chevron-left"></i></button>
